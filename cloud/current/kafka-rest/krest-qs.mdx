	...
	<Tabs>
        ...
        <Steps>
            ...
            <Step>
                ...
                <Frame>
                [![../_images/rest-api-qs-endpoint-on-ui.png](https://docs.confluent.io/cloud/current/_images/rest-api-qs-endpoint-on-ui.png)](https://docs.confluent.io/cloud/current/_images/rest-api-qs-endpoint-on-ui.png)
                </Frame>
            </Step>
        </Steps>
        </Tab>
...
<Steps>
<Step>
Create a Confluent Cloud cluster-scoped API key and secret.
	To communicate with the REST API, you need a Confluent Cloud API key and API secret. You can generate an API key pair by using the CLI or Cloud Console.
    <Tabs>
        <Tab title="CLI">
        <Steps>
            <Step>
        ...
        <Steps>
            ...
            <Step>
                ...
                <Frame>
                [![Confluent Cloud API keys](https://docs.confluent.io/cloud/current/_images/rest-qs-cloud-api-keys-on-cluster-ui.png)](https://docs.confluent.io/cloud/current/_images/rest-qs-cloud-api-keys-on-cluster-ui.png)
                </Frame>
            </Step>
        </Steps>
        </Tab>
...
<Step>
    Use the API key ID and corresponding secret to create the base64 encoded string used in the authorization header that will be included in the REST calls to the Confluent Cloud API.
    To learn more, see [Authentication](https://docs.confluent.io/cloud/current/api.html#section/Object-Model) in the API documentation, which describes Cloud and Cluster API keys and base64 encoding.
...
<Step>
    (Optional) Store the base64 encoded key and secret in an environment variable for use in commands.
    To make rest of the steps in this quick start more efficient, you can optionally store the base64 encoded key and secret in an environment variable, then use the variable in subsequent commands. For example, to store the encoded key and secret in a variable called `MYKEY`:
...
<Steps>
<Step>
View the default configuration for the topic created in [Step 4](https://docs.confluent.io/cloud/current/kafka-rest/#rest-api-qs-create-topic).
...
Edit the topic configuration.
	You can find a full list of configuration properties in the [Topic Configurations](https://docs.confluent.io/platform/current/installation/configuration/topic-configs.html) reference in the Confluent Platform documentation.
...
<Step>
View the updated values for topic configuration.
    ...
    <Frame>
    [![../_images/rest-api-qs-topic-configs-ui.png](https://docs.confluent.io/cloud/current/_images/rest-api-qs-topic-configs-ui.png)](https://docs.confluent.io/cloud/current/_images/rest-api-qs-topic-configs-ui.png)
    </Frame>
</Step>
</Steps>
...
For additional examples, see the public GitHub site [kafka-rest/examples/produce\_v3](https://github.com/confluentinc/kafka-rest/tree/master/examples/produce_v3?session_ref=direct&url_ref=https%3A%2F%2Fdocs.confluent.io%2Fcloud%2Fcurrent%2Fkafka-rest%2Fkrest-qs.html).
</Info>
...
<Frame>
[![../_images/rest-api-qs-produce-batch-records-streaming.png](https://docs.confluent.io/cloud/current/_images/rest-api-qs-produce-batch-records-streaming.png)](https://docs.confluent.io/cloud/current/_images/rest-api-qs-produce-batch-records-streaming.png)
</Frame>
...
<Frame> 
[![../_images/rest-api-qs-produce-single-record.png](https://docs.confluent.io/cloud/current/_images/rest-api-qs-produce-single-record.png)](https://docs.confluent.io/cloud/current/_images/rest-api-qs-produce-single-record.png)
</Frame>
...
<Columns cols={2}>
<Card icon="arrow-right" horizontal title="Confluent Cloud REST APIs" href="https://docs.confluent.io/cloud/current/api.html#tag/Cluster-\(v3\)" />
<Card icon="arrow-right" horizontal title="Confluent Cloud APIs overview" href="https://docs.confluent.io/cloud/current/api.html#section/Introduction" />
<Card icon="arrow-right" horizontal title="Confluent CLI Install" href="https://docs.confluent.io/confluent-cli/current/install.html" />
<Card icon="arrow-right" horizontal title="Confluent CLI Command Reference" href="https://docs.confluent.io/confluent-cli/current/command-reference/confluent_completion.html" />
<Card icon="arrow-right" horizontal title="Use API Keys to Authenticate to Confluent Cloud" href="https://docs.confluent.io/cloud/current/security/authenticate/workload-identities/service-accounts/api-keys/overview.html#cloud-api-keys" />
<Card icon="arrow-right" horizontal title="Quick Start for Confluent Cloud" href="https://docs.confluent.io/cloud/current/get-started/index.html#cloud-quickstart" />
</Columns>
